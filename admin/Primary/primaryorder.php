        ...
        <div class="container-fluid"  id="divmain">
            ...
            <div class="card shadow mb-4" id="divmain2">
                <div class="card-header py-3">
                    <?php if($add==1)
                    {?>
                        <button onclick="addprimary()" class="btn btn-success"><i class="fas fa-fw fa-plus"></i></button>
               <?php
                    }
                        ?>
                     </div>
...
<script>
    ...
    $(document).on('click', '#add', function() {
        ...
        $('#dynamic_field').append('<tr id="row' + i + '"><input type="hidden" id="itemid_' + i + '" name="itemid_' + i + '" readonly class="form-control" >' +
            ...
            '                        <td><input type="int" pattern="^[0-9]*$" name="quantity_' + i + '" id="quantity_' + i + '" class="form-control name_list btn_qty" required oninput="this.value = this.value.replace(/[^0-9]/g, \'\').replace(/(\\.*)\\./g, \'$1\');"  onkeyup="setTotalPricing(this);" autocomplete="off"/></td>\n' +
